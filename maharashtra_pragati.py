...
def get_data():
    data = {
      ...
      "Pragati+": [90,10,15,75,20,0,25,20,0,25,25,175,125,200,200,100,150,50,0,97,60,70,10,15,45,5,35,166,15,10,25,50,15,150,200,200],
      "VIL": [0]*36,
      "Alucolour": [0]*36,
      "Endura+": [33,40,5,15,0,0,15,0,0,0,0,30,0,0,25,0,0,0,0,0,0,0,5,13,5,3,5,90,5,5,25,100,25,100,100,61],
      "Infinia": [0]*36,
...
target_brand = st.sidebar.selectbox("Select Target Brand", ["Pragati+", "VIL", "Alucolour", "Endura+", 
                                                            "Infinia", "APL Apollo Rooftuff", "Jindal Sabrang","APL Coral","APL Jumbo",
                                                            "AM/NS Optigal 10 yW", "Others"])

brand_cols = ["Pragati+", "VIL", "Alucolour", "Endura+","Infinia", "APL Apollo Rooftuff", "Jindal Sabrang","APL Coral","APL Jumbo","AM/NS Optigal 10 yW", "Others"]
...
with t2:
    comp_cols = ["Infinia", "APL Apollo Rooftuff", "Jindal Sabrang","APL Coral","APL Jumbo","AM/NS Optigal 10 yW", "Others"]
