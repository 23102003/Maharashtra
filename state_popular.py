...
def get_state_data(state_name):
    ...
    if state_name == "Maharashtra":
        ...
        "Indradhanush": [30,30,20,250,50,50,300,25,25,200,50,350,50,550,150,0,150,400,0,550,1000,950,10,60,60,15,15,1202,10,30,100,300,50,350,1250,250],
    ...
    # GUJARAT DATA (Placeholder - Replace with your actual data)
        ...
        data = {
            ...
            "Indradhanush": [450, 5, 5, 5, 5, 5, 400, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15],   
